...
export function GalleryPage({ onNavigate }: GalleryPageProps) {
  ...
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-br from-[#f7fbff] via-white to-[#eef7ff]">
      ...
      {/* Before and After - same layout as HomePage */}
          ...
          <div className="space-y-10">
            {treatmentSections.map((section) => {
              ...
              return (
                <Card
                  key={section.id}
                  className="rounded-3xl border border-primary/10 bg-white overflow-hidden shadow-sm hover:shadow-premium-lg transition-all duration-300"
                >
      ...
      {/* Meet Our Doctors */}
      <section className="py-24 bg-gradient-to-br from-[#E7F6FD] to-white border-y border-primary/10">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl text-foreground mb-4 font-semibold">Meet Our Doctors</h2>
            <p className="text-muted-foreground max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
            {displayDoctors.map((doctor) => (
              <Card
                key={doctor.id}
                className="group h-full overflow-hidden rounded-3xl border border-primary/10 bg-white hover:shadow-premium-lg transition-all duration-300"
              >
